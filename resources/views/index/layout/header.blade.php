<div class="topbar">
    ...
    <div class="topbar-left">
        <div class="text-center">
            <a href="" class="logo"><i class="icon-fire"></i><span> QL Học Sinh</span></a>
            <!--Image Logo here-->
        ...
        <div class="container">
            <div class="">
                ...
                <ul class="nav navbar-nav hidden-xs">
                    {{--<li><a class="waves-effect waves-light">Số bệnh nhân có thể khám còn lại là: <strong style=" font-size: 1.25em"></strong></a></li>--}}
